...
grep -Fq "selfRunDriveVersionCode = 3027003" "$BUILD"
grep -Fq "selfRunDriveVersionName = '3.2.7-dev3'" "$BUILD"
...
echo 'SelfRun 3.2.7-dev3 ON_DEVICE core identity, migration, committed-only result gate, transport-retry, stopped-resume, unbounded-payload and runtime-settings checks passed.'
