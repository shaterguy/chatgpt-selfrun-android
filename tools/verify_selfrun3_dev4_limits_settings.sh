...
grep -Fq "selfRunDriveVersionCode = 3029000" "$BUILD"
grep -Fq "selfRunDriveVersionName = '3.2.8'" "$BUILD"
...
echo 'SelfRun 3.2.8 ON_DEVICE core identity, migration, committed-only result gate, transport-retry, stopped-resume, unbounded-payload and runtime-settings checks passed.'
