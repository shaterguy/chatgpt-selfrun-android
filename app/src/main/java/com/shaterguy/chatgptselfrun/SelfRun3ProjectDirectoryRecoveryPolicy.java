...
/** Bounded per-document recovery policy for intermittent ChatGPT project-directory hydration and no-op clicks. */
final class SelfRun3ProjectDirectoryRecoveryPolicy {
    ...
    static final int RECOVERIES_PER_HOST = 3;
    ...
    static boolean shouldRecreateHost(int recoveryNumber) {
        return recoveryNumber > 0 && recoveryNumber % RECOVERIES_PER_HOST == 0;
    }
}
