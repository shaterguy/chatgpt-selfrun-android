...
final class HeadlessWebViewHost {
    ...
    /**
     * Runtime Surface suspension is intentionally disabled.
     * Historical SelfRun builds kept the headless page continuously attached; later observer-wait
     * detachment caused the SPA to lose its live composer on current WebView builds. Keep the
     * ImageReader drain and raster cap for power control, but do not change display visibility
    ...
    /** Generation waits use the same always-attached lifecycle contract. */
