...
private void bootstrapSubmitted(String detail){if(!canRun())return;store.bootstrapSubmissionConfirmed();runLog.record(store,"BOOTSTRAP_SUBMISSION_CONFIRMED","detail="+detail+";command_received_ack=unused");releaseWakeLock();scheduleDrivePoll(0L);}
