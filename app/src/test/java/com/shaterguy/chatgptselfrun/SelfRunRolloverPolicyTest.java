...
public final class SelfRunRolloverPolicyTest {
    ...
    @Test public void postDispatchNoStartNeedsAContinuousValidatedWindowAndStopsTimingAfterGenerationStarts() {
        ...
        assertEquals(SelfRunRolloverPolicy.NO_START_WAIT, SelfRunRolloverPolicy.postDispatchNoStartAction(phaseStarted,true,phaseStarted,deadline,false));
        assertEquals(SelfRunRolloverPolicy.NO_START_WAIT, SelfRunRolloverPolicy.postDispatchNoStartAction(phaseStarted,true,phaseStarted,deadline,true));
    ...
    @Test public void unrelatedTransientAfterVisibleGenerationCannotPauseTheTurn() {
        long started=10_000L;
        long afterDeadline=started+SelfRunRolloverPolicy.CONTINUATION_NO_START_MAX_WAIT_MS+1L;
        assertEquals(SelfRunRolloverPolicy.NO_START_WAIT,
                SelfRunRolloverPolicy.postDispatchNoStartAction(started,true,started,afterDeadline,true));
    }
